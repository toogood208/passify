...
extension CategoriesByIndex on IsarCollection<Categories> {
  Future<Categories?> getByName(String name) {
    return getByIndex(r'name', [name]);
  }

  Categories? getByNameSync(String name) {
  ...
  Future<List<Categories?>> getAllByName(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
    return getAllByIndex(r'name', values);
  }

  List<Categories?> getAllByNameSync(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
  ...
  Future<Id> putByName(Categories object) {
    return putByIndex(r'name', object);
  }

  Id putByNameSync(Categories object, {bool saveLinks = true}) {
    return putByIndexSync(r'name', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByName(List<Categories> objects) {
    return putAllByIndex(r'name', objects);
  }

  List<Id> putAllByNameSync(List<Categories> objects, {bool saveLinks = true}) {
...
extension CategoriesQueryWhere
  ...
  QueryBuilder<Categories, Categories, QAfterWhereClause> nameEqualTo(
      String name) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Categories, Categories, QAfterWhereClause> nameNotEqualTo(
      String name) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
